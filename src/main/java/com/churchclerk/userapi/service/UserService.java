...
import com.churchclerk.userapi.storage.UserStorage;
...
public class UserService {
	...
	public Page<? extends User> getResources(Pageable pageable, User criteria) {
		...
		Page<UserEntity> page = storage.findAll(new ResourceSpec(criteria), pageable);
	...
	public String authenticate(User resource, String location) {
		...
		token.setId(resource.getName() + "|" + optional.get().getChurchUUID());
